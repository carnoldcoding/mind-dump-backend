...
#
# If the service does not answer after restarting, this puts the previous
# version back and restarts again, so a bad deploy self-reverts rather than
# leaving the API down while nobody is looking.
